...
const api = {
   ...
   */ fetchProfile: async (userId, email)=>{
        ...
        while(attempts < 5){
            try {
                ...
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc('rpc_get_my_profile');
                if (error) {
   ...
   */ ensureProfile: async (user)=>{
        ...
        let attempts = 0;
        while(attempts < 5){
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('*').eq('id', user.id).maybeSingle();
            if (data) return data;
    ...
    staffGetCustomer: async (publicId)=>{
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc('rpc_staff_get_customer_by_public_id', {
    ...
    staffAddPoints: async (publicId, amountCents)=>{
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc('rpc_staff_add_points', {
            public_id_query: publicId,
   ...
   */ convertPoints: async (customerId, spinsToBuy)=>{
        try {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc('rpc_convert_points_to_spins', {
   ...
   */ spinWheel: async (customerId)=>{
        try {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc('rpc_spin');
...
const initialState = {
    currentUser: null,
    activeRole: __TURBOPACK__imported__module__$5b$project$5d2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UserRole"].UNKNOWN,
    users: {},
...
const AppProvider = ({ children })=>{
    ...
    // --- Actions (Async Wrappers around API) ---
    const actions = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
        "AppProvider.useMemo[actions]": ()=>({
                logout: ({
                    "AppProvider.useMemo[actions]": async ()=>{
                ...
                grantSpinsByPublicId: ({
                    "AppProvider.useMemo[actions]": async (staffId, publicId, billAmount)=>{
                ...
                convertPointsToSpins: ({
                    "AppProvider.useMemo[actions]": async (customerId, spinsToBuy)=>{
                ...
                spinWheel: ({
                    "AppProvider.useMemo[actions]": async (customerId)=>{
                ...
                redeemCoupon: ({
                    "AppProvider.useMemo[actions]": async (staffId, code)=>{
                ...
                clearNewRewardFlag: ({
                    "AppProvider.useMemo[actions]": ()=>dispatch({
                            type: 'CLEAR_NEW_REWARD_FLAG'
                        })
                })["AppProvider.useMemo[actions]"],
                setUser: ({
                    "AppProvider.useMemo[actions]": (user)=>dispatch({
                            type: 'SET_USER',
                            payload: user
                        })
                })["AppProvider.useMemo[actions]"],
                setLoading: ({
                    "AppProvider.useMemo[actions]": (loading)=>dispatch({
                            type: 'SET_LOADING',
                            payload: loading
                        })
                })["AppProvider.useMemo[actions]"],
                setLogs: ({
                    "AppProvider.useMemo[actions]": (logs)=>dispatch({
                            type: 'SET_LOGS',
                            payload: logs
                        })
                })["AppProvider.useMemo[actions]"]
...
_s(AppProvider, "I5n3FpHNG8SCr0TzhKoobrMmVOk=");
_c = AppProvider;
const useAppStore = ()=>{
    _s1();
...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            const initAuth = {
                "AuthProvider.useEffect.initAuth": async ()=>{
                    try {
                        ...
                        const { data: { session: currentSession }, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
                        if (error) {
            ...
            const { data: { subscription } } = __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange({
    ...
    const loadProfile = async (user)=>{
        ...
        try {
            ...
            const { data: rpcData, error: rpcError } = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc('rpc_get_my_profile');
            ...
            if (rpcError) {
                ...
                const { data: directData, error: directError } = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('*').eq('id', user.id).single();
                ...
                if (directData) {
                    const profile = {
                        ...
                        role: (0, __TURBOPACK__imported__module__$5b$project$5d2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizeRole"])(directData.role),
                ...
                const profile = {
                    ...
                    role: (0, __TURBOPACK__imported__module__$5b$project$5d2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizeRole"])(rpcData.role),
...
_s1(AuthProvider, "00rwTvoUR4NucFzQlB7xYl85FGA=", false, function() {
    return [
...
//# sourceMappingURL=_489f02df._.js.map